...
# NOT: YOLO artık tracker_bbox kanalına yayın YAPMAZ.
# Sadece Redis KV'ye (b_box, confidence, vb.) yazar.
# tracker_bbox kanalına yalnızca SiamRPN tracker yazar.

# Cihaz
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# YOLO model
yolo_model = YOLO("v10son.pt")
if device.type == "cuda":
