...
class AutopilotController:
    def __init__(self, connection_str='udp:127.0.0.1:14562'):
        ...
        # self.center_x = 1091  # 960
        # self.center_y = 633   # 540
        self.center_x =  1091
        self.center_y = 633
        self.fx = 4515
        self.fy = 4510
...
if __name__ == '__main__':
    guidance = AutopilotController(connection_str='udp:127.0.0.1:14562')
    guidance.run()

# 16 mm 1920 x 1080 23 July new aircraft first test flight.
