...
class AutopilotController:
    def __init__(self, connection_str='udp:127.0.0.1:14552'):
        ...
        self.Kp_alt = 0.7       # 1 derece hata = 1.5 metre irtifa değişimi
        self.Ki_alt = 0.0
        self.Kd_alt = 0.12
        ...
        self.target_airspeed = 20.0  # Sequential tuning için varsayılan hız (m/s)
            ...
            while True:
                ...
                if current_time - self.last_cmd_send_time >= 0.1:
                    if gorev == "Goruntulu" and self.mavlink.current_mode == "GUIDED":
                        ...
                        command_sent = 1
                        print(f"[{gorev}] OTONOM: HedefYön: {target_heading:.1f}° | Rate: {heading_rate:.1f}°/s | İrtifa: {target_alt:.1f}m | Hız: {spd:.1f}m/s")
                    else:
...
if __name__ == '__main__':
    gudum = AutopilotController(connection_str='udp:127.0.0.1:14553')
    gudum.run()
